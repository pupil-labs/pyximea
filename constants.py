...
XI_PRM_DOWNSAMPL                    = "downsampling"            # Change image resolution by binning or skipping.
XI_PRM_DOWNSAMPL_TYPE               = "downsampling_type"       # Change image downsampling type. XI_DOWNSAMPL_TYPE
...
XI_PRM_SENSOR_PIXEL_CLOCK_FREQ_EX   = "sensor_pixel_clock_freq_index"# Sensor pixel clock frequency. Selects frequency index for getter of XI_PRM_SENSOR_PIXEL_CLOCK_FREQ_HZ parameter.
...
XI_PRM_OUTPUT_DATA_PACK             = "output_bit_packing"      # Device output data packing (or grouping) enabled. Packing could be enabled if output_data_bit_depth > 8 and packing is available. XI_SWITCH
...
XI_PRM_UT_CMS_PROFILE               = "input_cms_profile"       # Filename for input cms profile (e.g. input.icc)
XI_PRM_UT_CMS_PROFILE              = "output_cms_profile"      # Filename for output cms profile (e.g. input.icc)
...
XI_PRM_COOL                         = "cooling"                 # Start camera cooling. XI_SWITCH
...
XI_PRM_HDR_KNEEPO_COUNT             = "hdr_kneepoint_count"     # The number of kneepoints in the PWLR.
...
XI_PRM_KNEEPO1                      = "hdr_kneepoint1"          # value of first kneepoint (% of sensor saturation)
XI_PRM_KNEEPO2                      = "hdr_kneepoint2"          # value of second kneepoint (% of sensor saturation)
...
XI_PRM_O_M            =":min"               # Parameter minimum
XI_PRM_O_MAX             =":max"               # Parameter maximum
XI_PRM_O_REMENT       =":inc"               # Parameter increment
XI_PRM_O                 =":info"              # Parameter value
...
1 : ("XI_ALID_HANDLE","Invalid handle"),
...
10 : ("XI_TIME","Timeout"),
11 : ("XI_ALID_ARG","Invalid arguments supplied"),
...
22 : ("XI_ALID_TM_FILE","Invalid TM file"),
23 : ("XI_ALID_TM_TAG","Invalid TM tag"),
24 : ("XI_OMPLETE_TM","Incomplete TM"),
25 : ("XI_BUS_RESET_FAILED","Bus reset error"),
26 : ("XI_NOT_IMPLEMENTED","Not implemented"),
27 : ("XI_SHAD_TOOBRIGHT","Shading too bright"),
28 : ("XI_SHAD_TOODARK","Shading too dark"),
29 : ("XI_TOO_LOW_GA","Gain is too low"),
30 : ("XI_ALID_BPL","Invalid bad pixel list"),
31 : ("XI_BPL_REALLOC","Bad pixel list realloc error"),
32 : ("XI_ALID_PIXEL_LIST","Invalid pixel list"),
33 : ("XI_ALID_FFS","Invalid Flash File System"),
34 : ("XI_ALID_PROFILE","Invalid profile"),
35 : ("XI_ALID_CALIBRATION","Invalid calibration"),
36 : ("XI_ALID_BUFFER","Invalid buffer"),
38 : ("XI_ALID_DATA","Invalid data"),
...
47 : ("XI_ALID_UT_ICC_PROFILE","Input ICC profile missed or corrupted"),
48 : ("XI_ALID_UT_ICC_PROFILE","Output ICC profile missed or corrupted"),
49 : ("XI_DEVICE_NOT_READY","Device not ready to operate"),
50 : ("XI_SHAD_TOOCONTRAST","Shading too contrast"),
51 : ("XI_ALREADY_TIALIZED","Modile already initialized"),
...
54 : ("XI_TM_ALID_RESOURCE","TM file was not loaded successfully from resources"),
...
107 : ("XI_NOT_SUPPORTED_PARAM_O","Parameter info not supported"),
...
112 : ("XI_ALID_FFS_FILE_NAME","FFS file selector is invalid or NULL"),
113 : ("XI_FFS_FILE_NOT_FOUND","FFS file not found"),
201 : ("XI_PROC_OTHER_ERROR","Processing error - other"),
202 : ("XI_PROC_PROCESS_ERROR","Error while image processing."),
203 : ("XI_PROC_UT_FORMAT_UNSUPPORTED","Input format is not supported for processing."),
204 : ("XI_PROC_UT_FORMAT_UNSUPPORTED","Output format is not supported for processing.")
}
